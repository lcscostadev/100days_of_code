...
você precisa criar um programa que para um número impar, retornar 1 e para o número par retornar 0. primeiro faça um if vendo se o 1° número é 0, se for, retorna uma string vazia, crie uma variável resultado com uma string vazia, faça um loop, i começa valendo 1, se o i for menor que number, i++, ai você faz um if para saber se o número é impar, com a expressão i % 2 === 1, else, retorna 0, depois retorne result, fora do loop.
*/